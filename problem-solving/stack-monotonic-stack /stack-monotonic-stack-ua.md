...
**Stack** — це структура даних із принципом LIFO (_Last In — First Out_), яка зберігає інформацію в зворотному порядку. У задачах часто допомагає відслідковувати останній важливий стан, перевіряти парність дужок, або знаходити попередні менші/більші значення.
